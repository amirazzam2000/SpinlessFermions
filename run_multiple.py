...
# no pre no freezing 
os.system("python3 run.py -V 5 -S 0.3 -DIR {} -UL 1 -LL 1 --epochs 100000 > out/no_trans_no_freezing_no_MH.txt".format(directory))

model_name = "partial_data/model-OG"
os.system("python3 run.py -V 0 -S 0.5 -M {} -DIR {} -UL 1 -LL 1 --epochs 100000 > out/dumb.txt".format(model_name, directory))

# transfer learning (no freezing)
os.system("python3 run.py -V 5 -S 0.3  -LM {} -DIR {} -UL 1 -LL 1 --epochs 100000 --preepochs 0 > out/w_trans_no_freezing_no_MH.txt".format(model_name, directory))

# transfer learning (freezing)
os.system("python3 run.py -V 5 -S 0.3  -LM {} -DIR {} -UL 1 -LL 1 --epochs 100000 --preepochs 0 -F > out/w_trans_w_freezing_no_MH.txt".format(model_name, directory))

# weighted MH [no trans] (no freezing)
os.system("python3 run.py -V 5 -S 0.3  -LM {} -DIR {} -UL 100 -LL 10 --epochs 100000 > out/no_trans_no_freezing_w_MH.txt".format(model_name, directory))

# with transfer learning :

# weighted MH (no freezing)
os.system("python3 run.py -V 5 -S 0.3  -LM {} -DIR {} -UL 100 -LL 10 --epochs 100000 --preepochs 0 > out/w_trans_no_freezing_w_MH.txt".format(model_name, directory))

# weighted MH (freezing)
os.system("python3 run.py -V 5 -S 0.3  -LM {} -DIR {} -UL 100 -LL 10 --epochs 100000 --preepochs 0 -F > out/w_trans_w_freezing_w_MH.txt".format(model_name, directory))
