...
directory_base = "results/energy/data/Early_Stopping_Testing_complete"
...
os.system("python3 run.py -N 4 -V 5 -S 0.3  -DIR {} -UL 10 -LL 100 --epochs 100000 -T 'ES_' > {}/no_trans_no_freezing_w_MH.txt".format(directory, out_dir))
...
os.system("python3 run.py -N 2 -V 5 -S 0.3  -M {} -DIR {} -UL 10 -LL 100 --epochs 100000 -T 'ES_' >> {}/dumb.txt".format(model_name, directory, out_dir))

os.system("python3 run.py -N 4 -V 5 -S 0.3   -LM {} -DIR {} -UL 10 -LL 100 --epochs 100000 --preepochs 0 -F -T 'ES_' > {}/no_trans_w_freezing_w_MH.txt".format(model_name, directory, out_dir))
...
model_name = "partial_data/model-A4-for-trans"
os.system("python3 run.py -N 4 -V 0 -S 0.5  -M {} -DIR {} -UL 10 -LL 100 --epochs 100000 -T 'ES_' >> {}/dumb.txt".format(model_name, directory, out_dir))

os.system("python3 run.py -N 4 -V 5 -S 0.3   -LM {} -DIR {} -UL 10 -LL 100 --epochs 100000 --preepochs 0 -T 'ES_' > {}/w_trans_no_freezing_w_MH.txt".format(model_name, directory, out_dir))
...
os.system("python3 run.py -N 2 -V 0 -S 0.5  -M {} -DIR {} -UL 10 -LL 100 --epochs 100000 -T 'ES_' >> {}/dumb.txt".format(model_name, directory, out_dir))

model_name_f = "partial_data/model-A2-after-freezing-for-trans-w-MH"
os.system("python3 run.py -N 4 -V 0 -S 0.5   -M {} -LM {} -DIR {} -UL 10 -LL 100 --epochs 100000 --preepochs 0 -F -T 'ES_' > {}/w_trans_w_freezing_w_MH_part1.txt".format(model_name_f, model_name, directory, out_dir))

os.system("python3 run.py -N 4 -V 5 -S 0.3   -LM {} -DIR {} -UL 10 -LL 100 --epochs 100000 --preepochs 0 -T 'ES_' > {}/w_trans_w_freezing_w_MH_part2.txt".format(model_name_f, directory, out_dir))
os.system("python3 run.py -N 4 -V 5 -S 0.3   -LM {} -DIR {} -UL 10 -LL 100 --epochs 100000 --preepochs 0 -F -T 'ES_' > {}/w_trans_w_freezing_w_MH_part2.txt".format(model_name_f, directory, out_dir))
...
os.system("python3 run.py -N 4 -V 0 -S 0.5   -M {} -LM {} -DIR {} -UL 1 -LL 1 --epochs 100000 --preepochs 0 -F -T 'ES_' > {}/w_trans_w_freezing_w_MH_part1.txt".format(model_name_f, model_name, directory, out_dir))

os.system("python3 run.py -N 4 -V 5 -S 0.3   -LM {} -DIR {} -UL 1 -LL 1 --epochs 100000 --preepochs 0 -T 'ES_' > {}/w_trans_w_freezing_w_MH_part2.txt".format(model_name_f, directory, out_dir))
os.system("python3 run.py -N 4 -V 5 -S 0.3   -LM {} -DIR {} -UL 1 -LL 1 --epochs 100000 --preepochs 0 -F -T 'ES_' > {}/w_trans_w_freezing_w_MH_part2.txt".format(model_name_f, directory, out_dir))
