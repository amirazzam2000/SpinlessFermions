...
os.system("python3 run.py -V 10 -S 0.3 -M {} --epochs 100000 -DIR {}".format(model_name, directory))

os.system(
    "python3 run.py -V 0 -S 0.3 -M {} -DIR {} --epochs 100000 --preepochs 0".format(model_name, directory))
