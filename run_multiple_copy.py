...
os.system("python3 run.py -N {} -V 10 -S 0.5  -DIR {} -UL 100 -LL 1 --epochs {}  {} -T {} -SW 40 > {}/no_trans_no_freezing_w_MH.txt".format(
...
os.system("python3 run.py -N {} -V 10 -S 0.5 -LM {} -DIR {} -UL 100 -LL 1 --epochs {}  --preepochs 0 -F {} -T {} -SW 40 > {}/no_trans_w_freezing_w_MH.txt".format(
...
os.system("python3 run.py -N {} -V 10 -S 0.5  -DIR {} -UL 1 -LL 1 --epochs {}  {} -T {} -SW 40 > {}/no_trans_no_freezing_no_MH.txt".format(
...
os.system("python3 run.py -N {} -V 10 -S 0.5 -LM {} -DIR {} -UL 1 -LL 1 --epochs {}  --preepochs 0 -F {} -T {} -SW 40 > {}/no_trans_w_freezing_no_MH.txt".format(
    num_particles, model_name, directory, num_epochs, noes, tag, out_dir))
...
os.system("python3 run.py -N {} -V 10 -S 0.5   -LM {} -DIR {} -UL 1 -LL 1 --epochs {}  --preepochs 0 {} -T {} -SW 40 > {}/w_trans_no_freezing_no_MH.txt".format(
    num_particles, model_name, directory, num_epochs, noes, tag, out_dir))
...
os.system("python3 run.py -N {} -V 5 -S 0.5   -M {} -LM {} -DIR {} -UL 100 -LL 1 --epochs {}  --preepochs 0 -F {} -T {} -SW 60 > {}/w_trans_w_freezing_w_MH_part1.txt".format(
    num_particles, model_name_f, model_name, directory, num_epochs, noes, tag, out_dir))

os.system("python3 run.py -N {} -V 10 -S 0.5   -LM {} -DIR {} -UL 100 -LL 1 --epochs {}  --preepochs 0 {} -T {} -SW 60 > {}/w_trans_w_freezing_w_MH_part2.txt".format(
    num_particles, model_name_f, directory, num_epochs, noes, tag + "_w_trans_w_freezing", out_dir))
os.system("python3 run.py -N {} -V 10 -S 0.5   -LM {} -DIR {} -UL 100 -LL 1 --epochs {}  --preepochs 0 -F {} -T {} -SW 60 >> {}/w_trans_w_freezing_w_MH_part2.txt".format(
...
os.system("python3 run.py -N {} -V 5 -S 0.5   -M {} -LM {} -DIR {} -UL 1 -LL 1 --epochs {}  --preepochs 0 -F {} -T {} -SW 40 > {}/w_trans_w_freezing_no_MH_part1.txt".format(
    num_particles, model_name_f, model_name, directory, num_epochs, noes, tag, out_dir))

os.system("python3 run.py -N {} -V 10 -S 0.5   -LM {} -DIR {} -UL 1 -LL 1 --epochs {}  --preepochs 0 {} -T {} -SW 40 > {}/w_trans_w_freezing_no_MH_part2.txt".format(
    num_particles, model_name_f, directory, num_epochs, noes, tag + "_w_trans_w_freezing", out_dir))
os.system("python3 run.py -N {} -V 10 -S 0.5   -LM {} -DIR {} -UL 1 -LL 1 --epochs {}  --preepochs 0 -F {} -T {} -SW 40 >> {}/w_trans_w_freezing_no_MH_part2.txt".format(
    num_particles, model_name_f, directory, num_epochs, noes, tag + "_w_trans_w_freezing_w_freezing", out_dir))
