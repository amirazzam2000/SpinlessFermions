...
# os.system("python3 run.py -N {} -V 10 -S 0.5  -DIR {} -UL 1 -LL 1 --epochs 100000  {} -T {} -SW 40 > {}/no_trans_no_freezing_no_MH.txt".format(
#     num_particles, directory, noes, tag, out_dir))
...
# os.system("python3 run.py -N {} -V 10 -S 0.5  -M {} -DIR {} -UL 1 -LL 1 --epochs 100000  {} -T {} > {}/dumb.txt".format(
#     num_pre_particles, model_name, directory, noes, tag, out_dir))

# os.system("python3 run.py -N {} -V 10 -S 0.5 -LM {} -DIR {} -UL 1 -LL 1 --epochs 100000  --preepochs 0 -F {} -T {} -SW 40 > {}/no_trans_w_freezing_no_MH.txt".format(
...
# # os.system("python3 run.py -N {} -V 10 -S 0.5   -LM {} -DIR {} -UL 1 -LL 1 --epochs 100000  --preepochs 0 {} -T {} -SW 40 > {}/w_trans_no_freezing_no_MH.txt".format(
# #     num_particles, model_name, directory, noes, tag, out_dir))
...
# os.system("python3 run.py -N {} -V 10 -S 0.5  -DIR {} -UL 100 -LL 1 --epochs 100000  {} -T {} -SW 40 > {}/no_trans_no_freezing_w_MH.txt".format(
#     num_particles, directory, noes, tag + 'WMH', out_dir))
...
# model_name = "partial_data/model-A4-for-trans" + model_name_tag
# os.system("python3 run.py -N {} -V 5 -S 0.5  -M {} -DIR {} -UL 100 -LL 1 --epochs 100000  {} -T {} >> {}/dumb.txt".format(
#     num_particles, model_name, directory, noes, tag, out_dir))

# os.system("python3 run.py -N {} -V 10 -S 0.5   -LM {} -DIR {} -UL 100 -LL 1 --epochs 100000  --preepochs 0 {} -T {} -SW 40 > {}/w_trans_no_freezing_w_MH.txt".format(
#     num_particles, model_name, directory, noes, tag, out_dir))
