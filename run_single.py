...
os.system("python3 run.py -N {} -V 10 -S 0.5  -DIR {} -UL 1 -LL 1 --epochs {} {} -T {} > {}/no_trans_no_freezing_no_MH.txt".format(num_particles, directory, num_epochs, noes, tag, out_dir))
